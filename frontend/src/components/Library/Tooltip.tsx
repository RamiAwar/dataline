  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        ...
        <div className="group flex ml-auto gap-2 rounded-md bg-gray-700/50 hover:bg-gray-100/90 hover:text-gray-700/90 text-gray-100/50 transition-all duration-150 ease-in-out border border-white/10 data-[hover]:border-white/20">
          {children}
        </div>
      </div>
    </div>
