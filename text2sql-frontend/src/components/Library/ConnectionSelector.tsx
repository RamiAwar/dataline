...
export const ConnectionSelector = () => {
  ...
  return (
    <div className="bg-gray-900 w-full h-screen relative flex flex-col -mt-16 lg:mt-0 justify-center">
      <Transition
        enter="transition duration-300 ease-out transform h-full"
      ...
      >
        <div className="flex flex-col justify-center items-center lg:mt-0">
          <div className="bg-gray-700 border-2 border-gray-500 w-full sm:w-1/2 md:w-3/4 rounded-xl p-6">
              ...
              {connections?.map((connection) => (
                ...
                >
                  ...
                  <div className="h-full flex justify-center items-center gap-6 text-gray-50 px-4 pb-2">
                    ...
                    <div className="group w-10 h-10 p-1 flex justify-center items-center hover:bg-slate-500 rounded-md duration-100 transition-colors">
